...
/* FLEXCAN1_RX */
/* Routed pin properties */
#define BOARD_BB_CAN1_RX_PERIPHERAL                                DMA__FLEXCAN1   /*!< Peripheral name */
#define BOARD_BB_CAN1_RX_SIGNAL                                       flexcan_rx   /*!< Signal name */
#define BOARD_BB_CAN1_RX_PIN_NAME                                    FLEXCAN1_RX   /*!< Routed pin name */
#define BOARD_BB_CAN1_RX_PIN_FUNCTION_ID                        SC_P_FLEXCAN1_RX   /*!< Pin function id */
#define BOARD_BB_CAN1_RX_LABEL                             "BB_CAN1_RX/J20C[25]"   /*!< Label */
#define BOARD_BB_CAN1_RX_NAME                                       "BB_CAN1_RX"   /*!< Identifier */

/* FLEXCAN1_TX */
/* Routed pin properties */
#define BOARD_BB_CAN1_TX_PERIPHERAL                                DMA__FLEXCAN1   /*!< Peripheral name */
#define BOARD_BB_CAN1_TX_SIGNAL                                       flexcan_tx   /*!< Signal name */
#define BOARD_BB_CAN1_TX_PIN_NAME                                    FLEXCAN1_TX   /*!< Routed pin name */
#define BOARD_BB_CAN1_TX_PIN_FUNCTION_ID                        SC_P_FLEXCAN1_TX   /*!< Pin function id */
#define BOARD_BB_CAN1_TX_LABEL                             "BB_CAN1_TX/J20C[26]"   /*!< Label */
#define BOARD_BB_CAN1_TX_NAME                                       "BB_CAN1_TX"   /*!< Identifier */
